...
- 2026-09-10 외부 Wallet SDK 비교: 계정·전송·이벤트·Sweep은 BCM 대체 범위다. DAW 완료 추적·복구·항목 대사를 코드와 대조했으며 주소 잔고/소유·용도 식별은 미구현 과제로 구분했다. SDK 채택·경계 변경 결정 없음. 정적 검토만 수행, 테스트 재실행·벤더 호출 없음.
