 ...
 * 4. **같은 canonical의 미결 제출이 없다** — 값이 같아도 그 제출의 것일 수 있으므로, 아직 hash를 못 받은 같은 값의 제출이
 *    남아 있으면 배제하지 못한 것이다([NetworkChainAttachmentResult.Unresolved]).
 *
