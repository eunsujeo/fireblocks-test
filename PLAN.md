...
- [ ] **다음 구현: tag/memo 체인 주소 모델과 Solana 자산 locator** — Solana(mint·Token Program·token account) 수신 주소 모델과 자산 키·`vndr_ast_id` 길이 확장 DDL을 03·07·13에서 확정한 뒤 구현한다. 그 뒤 거래·Sweep·Admin·웹훅의 Dfns 조립이다.
