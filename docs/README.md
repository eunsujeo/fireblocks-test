...
- SDK ↔ BCM 비교: [DAWBC / Wallet SDK 흐름 비교](flow-comparison/index.html) — 업무별 비교표·시퀀스 다이어그램·차이점과 확인 사항.
...
- 설계자 원장 v0.1.4: [업무·DB 가이드](ledger/index.html). `index.html`을 직접 열어 처리 순서·잔고 변화·원문을 확인합니다.
