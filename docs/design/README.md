...
| 사본 | waas-wiki 원본 |
|---|---|
| 01-infra.md ~ 99-detection-detail.md | `blockchain-manager/docs/BC/설계/` 동일 파일명 |
...
cp 설계/{01-infra,02-bcm-flow,03-bcm-db,06-sweep,07-asset-master,96-payload-sample,97-webhook-poc-result,98-batch-sweep,99-detection-detail}.md \
