      ...
      "AssetMapping": {
        ...
        "properties": {
          ...
          "dfnsAssetKey": {
            ...
            "description": "현재 매핑이 사용하는 Dfns 자산 키 `<Network>:Native` 또는 `<Network>:<kind>:<locator>`(ERC-20은 소문자 컨트랙트). Dfns 원천에서만 채워지고 Fireblocks 원천은 null",
      ...
      "RegisterAssetMappingRequest": {
        ...
        "properties": {
          ...
          "contractAddress": {
            ...
            "description": "발행사 공식 문서에서 확인한 컨트랙트 주소. 네이티브 자산이면 null. Dfns 원천에서는 이 값과 network가 자산 지정의 전부다",
            "example": "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913"
          }
        }
      },
