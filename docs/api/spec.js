  ...
  "paths": {
    ...
    "/admin/vaults": {
      "get": {
        ...
        "summary": "Fireblocks vault와 BCM 계정 대조",
        "description": "Fireblocks workspace의 vault를 끝까지 페이징하고 BCM 계정 레지스트리와 vendor vault id로 대조한다.\n계정·vault를 생성하지 않는 읽기 전용 진단 API이며, 자산별 잔액과 주소는 목록에서 선조회하지 않는다.\n",
        "operationId": "adminVaults",
        "parameters": [
          {
            "name": "q",
            "in": "query",
        ...
        "responses": {
          "200": {
            "description": "vault 대조 목록",
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/AdminVaultListResponse"
                }
              }
            }
          }
    ...
    "schemas": {
      ...
      "AssetMapping": {
        ...
        "properties": {
          ...
          "fireblocksAssetId": {
            "type": "string",
            "description": "현재 매핑이 사용하는 Fireblocks 자산 식별자",
            "example": "USDC_BASE"
          },
          "contractAddress": {
            "oneOf": [
      ...
      "RegisterAssetMappingRequest": {
        ...
        "properties": {
          ...
          "fireblocksAssetId": {
            "type": "string",
            "description": "후보 목록에서 선택한 Fireblocks Asset ID. 서버가 등록 직전에 Network·주소와 다시 검증한다",
            "example": "USDC_BASE"
          },
          "contractAddress": {
            "oneOf": [
      ...
      "Transfer": {
        ...
        "properties": {
          "txId": {
            "type": "string",
            "description": "최초 root 거래의 벤더 tx id"
          },
          "txHash": {
            "type": [
              "string",
